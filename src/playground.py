...
def run():
    ...
    run_model('/root/models/faster_rcnn_inception_v2_coco.pb', input_file_path, output_file_path)
    run_model('/root/models/ssdlite_mobilenet_v2_coco.pb', input_file_path, output_file_path)
    run_model('/root/models/ssd_resnet50_v1.pb', input_file_path, output_file_path)
