...
if not INPUT_PREFIX or not OUTPUT_PREFIX or not TRAINING_PREFIX:
    raise ValueError(
        'MINIO_INPUT_PREFIX and/or MINIO_OUTPUT_PREFIX and or MINIO_TRAINING_PREFIX environment variables missing'
    )

if INPUT_PREFIX[-1:] != '/' or OUTPUT_PREFIX[-1:] != '/' or TRAINING_PREFIX[-1:] != '/':
    raise ValueError(
        'Invalid MINIO_INPUT_PREFIX and/or MINIO_OUTPUT_PREFIX and/or MINIO_TRAINING_PREFIX environment variables'
    )
